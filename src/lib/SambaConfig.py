...
class SambaConfig():
    REQUIRED_CLI_TOOLS = ['testparm', 'samba', 'smbcontrol', 'smbstatus']
    ...
    def __init__(self, override_config_file_location=None) -> None:
        ...
        self.samba_version = SambaConfig.get_samba_version()
    ...
    def get_samba_version():
        smbv = terminal.host_sh(['samba', '--version'])
    ...
    def test_compatibility():
        ...
        for tool in SambaConfig.REQUIRED_CLI_TOOLS:
            if not terminal.host_sh(['which', tool]):
    ...
    def get_md5(self, file_path=None):
        ...
        print(self.config_file_location)
